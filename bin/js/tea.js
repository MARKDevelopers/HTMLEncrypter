/* 
 ...
 Drench lib so it's compatible with Crypt::tea)

 Twiddles adapted from Matthew Byng-Maddick's Crypt::tea_PP

 JavaScript encryption module ver. 2.0 by Daniel Rench, 2005-2007
 Based on existing code:
 Copyright (c) 2003 by Andre Mueller.
 Init of tea constants with a function (init/backup errors)
...
tea.prototype.Fbf_P=function(){return [
	0x243f6a88,0x85a308d3,0x13198a2e,0x03707344,0xa4093822,0x299f31d0,
	0x082efa98,0xec4e6c89,0x452821e6,0x38d01377,0xbe5466cf,0x34e90c6c,
	0xc0ac29b7,0xc97c50dd,0x3f84d5b5,0xb5470917,0x9216d5d9,0x8979fb1b
];};
tea.prototype.Fbf_S0=function(){return [
...
tea.prototype.Fbf_S1=function(){return [
...
tea.prototype.Fbf_S2=function(){return [
...
tea.prototype.Fbf_S3=function(){return [
...
// remix compatible with Crypt::tea
tea.prototype.encrypt = function (t)
{
...
// remix compatible with Crypt::tea
tea.prototype.decrypt = function (t)
{
...
tea.prototype.wordescape=function(w){
	var r='';
...
tea.prototype.wordunescape=function(t){
	var r=0;
	for(var i=6;i>=0;i-=2){
		var t1=t.charCodeAt(i);
...
tea.prototype.round=function(a,b,n){
	var t=this;
...
tea.prototype.encipher=function(){
	var t=this;
	var Xl=t.xl_par;
	var Xr=t.xr_par;
...
tea.prototype.decipher=function(){
	var t=this;
	var Xl=t.xl_par;
	var Xr=t.xr_par;
