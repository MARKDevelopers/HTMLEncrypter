...
public class Encrypter extends JFrame {
	...
	// Version label
	static JLabel LB4 = new JLabel("HTML Encrypter 1.0");
	...
	// Blue color
	static public Color color_blue = new Color(0xCE2F4E);
	// Global blank color
	...
	public Encrypter() {
		...
		in_pan41.add(LB3);
		in_pan41.add(combo);
		combo.insertItemAt("JavaScript Rabbit", 0);
		combo.insertItemAt("JavaScript MARC4", 1);
		combo.insertItemAt("JavaScript TEA", 2);
		combo.insertItemAt("JavaScript Escape", 3);
	...
	public static void main(String[] args) {
		loadSpinner splash = new loadSpinner(50);
			...
			SwingUtilities.invokeLater(new Runnable() {
				public void run() {
					...
					com.sun.awt.AWTUtilities.setWindowShape(
							w,
							new Rectangle2D.Double(0, 0, w.getWidth(), w
									.getHeight()));
				}
			});
		}
