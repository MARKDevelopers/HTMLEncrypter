...
public class setProp {
	...
	public setProp() {
		...
		Encrypter.pan1.setBackground(Encrypter.color_light);
		...
		Encrypter.in_pan11.setBackground(Encrypter.color_light);
		...
		Encrypter.exit.setBackground(Encrypter.color_light);
		...
		Encrypter.minim.setBackground(Encrypter.color_light);
		...
		Encrypter.mb.setBackground(Encrypter.color_light);
		ImageIcon maximize = getImageIcon("assets/icons/maximize_light.png");
		Encrypter.maxim.setBackground(Encrypter.color_light);
